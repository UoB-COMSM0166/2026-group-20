...
import { moveAndCollideX, moveAndCollideY, checkSpikeCollision } from '../src/systems/PhysicsSystem.js';
import { isSolid, isSpike } from '../src/maps/MapLoader.js';

// Mock dependencies
vi.mock('../src/maps/MapLoader.js', () => ({
    isSolid: vi.fn(),
    isSpike: vi.fn()
}));
...
describe('Physics Module', () => {
    ...
    describe('moveAndCollideX', () => {
        ...
        it('should collide with other ALIVE players', () => {
            const otherPlayer = { x: 50, y: 0, w: 20, h: 20, lifeState: 'ALIVE' };
            mockEntity.x = 40;
