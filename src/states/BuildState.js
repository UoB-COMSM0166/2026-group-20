...
export class BuildState extends State {
    ...
    _drawPalette(mx, my, playerCol) {
        ...
        const actionY   = row1Y + btnH + 4;  // sits below row1, 4px gap
        const actionH   = 30;
    ...
    /**
     * Remove the most recently placed obstacle from this turn and refund its token.
     * Called by the Undo button and remains reusable from right-click.
     * @private
     */
    _undoLast() {
